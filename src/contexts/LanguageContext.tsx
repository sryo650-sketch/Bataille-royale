...
export const translations = {
  fr: {
    ...
    mode_rapid_desc: '3 minutes pour dominer l\'arène. 3 charges spéciales activées ⚡ (Pas de points ELO)',
    mode_daily_desc: 'Scénario spécial renouvelé chaque jour.',
    ranked_mode_badge: 'CLASSÉ · ELO',
    ranked_back_warning: 'Retour = abandon (ELO)',
    rapid_timer_label: 'Chrono',
    ...
    look_card: 'DÉVOILE TON ARME ⚔️',
    your_turn: 'EN GARDE ! ⚔️',
    fight: 'COMBATTRE',
    waiting: 'En attente...',
    victory: 'VICTOIRE',
    defeat: 'DÉFAITE',
    ...
    rapid_mode_label: 'Duel Rapide (Casual)',
  ...
  en: {
    ...
    mode_rapid_desc: '3 minutes to claim victory. 3 special charges activated ⚡ (No ELO points)',
    mode_daily_desc: 'A scripted scenario refreshed every day.',
    ranked_mode_badge: 'RANKED · ELO',
    ranked_back_warning: 'Back = surrender (ELO loss)',
    rapid_timer_label: 'Timer',
    ...
    ready_fight: 'READY FOR BATTLE',
    duel_imminent: 'Duel imminent...',
    battle: 'PUGNA REGALIS!',
    round_won: 'Round Won!',
    round_lost: 'Round Lost...',
    touch_to_see: 'TAP TO REVEAL',
    look_card: 'REVEAL YOUR WEAPON ⚔️',
    your_turn: 'ON GUARD! ⚔️',
    fight: 'FIGHT',
    waiting: 'Waiting...',
    victory: 'VICTORY',
    defeat: 'DEFEAT',
    ...
    rapid_mode_label: 'Rapid Duel (Casual)',
