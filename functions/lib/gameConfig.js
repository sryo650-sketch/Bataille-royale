...
exports.DEFEAT_MESSAGES = exports.GAME_CONFIG = void 0;
exports.determineWinnerOnTimeout = determineWinnerOnTimeout;
exports.GAME_CONFIG = {
    // ⏱️ TIMERS
    RAPID_MODE_DURATION: 180, // 3 minutes (en secondes)
    ROUND_TIMEOUT: 10, // Temps max par round avant auto-lock (en secondes)
    MAX_TIMEOUTS: 3, // Nombre max de timeouts avant défaite automatique
    // ⚡ CHARGES SPÉCIALES
 ...
 */
function determineWinnerOnTimeout(p1Cards, p2Cards, p1Score, p2Score, mode) {
    const config = exports.GAME_CONFIG.WINNER_DETERMINATION;
